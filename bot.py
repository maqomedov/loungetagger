...
async def start(event):
  await event.reply("**LoungeTagger Bot**, Grup veya kanaldaki neredeyse tüm üyelerden bahsedebilirim ★\nDaha fazla bilgi için **/help**'i tıklayın.",
                    buttons=(
                      [Button.url('🌟 Beni Bir Gruba Ekle', 'https://t.me/EtiketlemeBot?startgroup=a'),
                      Button.url('📣 Support', 'https://t.me/RobotRoomChat'),
                      Button.url('🚀 Sahibim', 'https://t.me/KenanBitcoin')]
                    ),
                    link_preview=False
                   )
